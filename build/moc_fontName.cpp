...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MFontName_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MFontName_t qt_meta_stringdata_MFontName = {
    {
QT_MOC_LITERAL(0, 0, 9), // "MFontName"
QT_MOC_LITERAL(1, 10, 32), // "fontCurrentMicroSoftYaheiChanged"
QT_MOC_LITERAL(2, 43, 0), // ""
QT_MOC_LITERAL(3, 44, 25) // "fontCurrentMicroSoftYahei"

    },
    "MFontName\0fontCurrentMicroSoftYaheiChanged\0"
    "\0fontCurrentMicroSoftYahei"
};
...
void MFontName::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->fontCurrentMicroSoftYahei(); break;
        default: break;
        }
...
const QMetaObject MFontName::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MFontName.data,
      qt_meta_data_MFontName,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MFontName::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MFontName.stringdata0))
